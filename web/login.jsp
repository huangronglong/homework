  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href="index.html"> <img alt="light year admin" src="<%=path %>/images/logo-sidebar.png"> </a>
      </div>
      <form action="/StudentController/login" method="post">
        ...
        <div class="form-group">
          <button class="btn btn-block btn-primary" value="test" type="submit">立即登录</button>
        </div>
      </form>
      <hr>
    </div>
